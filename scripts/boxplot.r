...
df_bed_1_1 <- data.frame(bed_1_rpkm_WT, bed_1_rpkm_H33KO)



pdf('box_plot.pdf')
boxplot(df_bed_1_1, col=(c("gray","red")), main="Title", ylab="RPKM",outline=FALSE, notch=TRUE, names=c("WT","H3.3KO"), yaxt="n", cex.axis=1,las=2,lwd=4,lty=1, cex.axis=1,las=2,lwd=4,lty=1, ylim=c(0,4))
axis(2, at=c(0,2,4))
dev.off()
